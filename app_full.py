...
with st.sidebar:
    ...
    run_ai = st.toggle("Run AI Review", value=False)  # Disabled for now
...
if st.button("🚀 Analyze Project", type="primary"):
    ...
    try:
        ...
        tab1, tab2, tab3, tab4 = st.tabs([
            "📊 Overview", "🏗 Architecture", "🛡 Security & CVEs", "🎨 Compose"
        ])
...
st.markdown("---")
st.caption("🤖 Powered by Android Intelligence Agent")